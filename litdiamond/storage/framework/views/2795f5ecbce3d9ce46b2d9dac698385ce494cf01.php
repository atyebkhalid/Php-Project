    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                <?php echo e(Form::open(['url' => 'admin/products', 'id' => 'myForm'])); ?>
                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right">
                                        <button class="btn btn-primary btn-xs" type="button" onclick="location.href='<?php echo e(url('admin/products/add')); ?>'">Add New</button>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($Products as $product) {
                                                ?>
                                                <tr>
                                                    <td><input type="checkbox" class="chk" name="IDs[]" value="<?php echo e($product->ProductID); ?>" /></td>
                                                    <td><?php echo e($product->ProductID); ?></td>
                                                    <td><?php echo e($product->CategoryName); ?></td>
                                                    <td><?php echo e($product->ProductName); ?></td>
                                                    <td><img src="<?php echo e(url('public/uploads/products/'.$product->Image)); ?>" width="100" /></td>
                                                    <td><?php echo e($Statuses[$product->Status ]); ?></td>
                                                    <td><?php echo $product->DateAdded; ?></td>
                                                    <td><?php echo $product->DateModified; ?></td>
                                                    <td><button type="button" class="btn btn-primary btn-xs" onclick="location.href='<?php echo e(url('admin/products/edit/'.$product->ProductID)); ?>'">Edit</button></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>
...
<?php /**PATH C:\xampp\htdocs\Laravel\litdiamond\resources\views/admin/products/index.blade.php ENDPATH**/ ?>
...
<html>
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="<?php echo e(url('resources/admin')); ?>/plugins/iCheck/square/blue.css">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="<?php echo e(url('resources/admin')); ?>/index2.html"><b>LIT</b>Admin</a>
            </div>
            <!-- /.login-logo -->
            <div class="login-box-body">
                ...
                <?php echo e(Form::open(['url' => 'admin'])); ?>

                <div class="form-group has-feedback">
                    <?php echo e(Form::text('UserName', null, ['class' => 'form-control', 'placeholder' => 'Enter Username'])); ?>
        ...
        <!-- iCheck -->
        <script src="<?php echo e(url('resources/admin')); ?>/plugins/iCheck/icheck.min.js"></script>
        <script>
            $(function () {
                $('input').iCheck({
...
<?php /**PATH C:\xampp\htdocs\Laravel\litdiamond\resources\views/admin/login.blade.php ENDPATH**/ ?>
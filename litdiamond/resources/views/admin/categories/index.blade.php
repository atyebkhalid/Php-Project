                            ...
                            <div class="box">
                                <div class="box-header">
                                    ...
                                    <div class="pull-right">
                                        <button class="btn btn-primary btn-xs" type="button" onclick="location.href='{{ url('admin/categories/add') }}'">Add New</button>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($Categories as $category) {
                                                ?>
                                                <tr>
                                                    <td><input type="checkbox" class="chk" name="IDs[]" value="{{ $category->CategoryID }}" /></td>
                                                    <td>{{ $category->CategoryID }}</td>
                                                    <td>{{ $category->CategoryName }}</td>
                                                    <td>{{ $Statuses[$category->Status ] }}</td>
                                                    <td>{!! $category->DateAdded !!}</td>
                                                    <td>{!! $category->DateModified !!}</td>
                                                    <td><button type="button" class="btn btn-primary btn-xs" onclick="location.href='{{ url('admin/categories/edit/'.$category->CategoryID) }}'">Edit</button></td>
                                                </tr>
                                                <?php
                                            }
                                            ?>

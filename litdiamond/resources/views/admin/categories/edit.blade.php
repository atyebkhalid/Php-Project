    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">
                ...
                <!-- Main content -->
                {{ Form::open(['url' => 'admin/categories/edit/'.$Category->CategoryID]) }}
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('CategoryName', $Category->CategoryName, ['class' => 'form-control', 'id' => 'CategoryName', 'placeholder' => 'Enter Category Name']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        <label>Parent:</label>
                                                        {{ Form::select('ParentID', $Categories, $Category->ParentID, ['class' => 'form-control', 'placeholder' => 'Select Category']) }}
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Status:</label>
                                                        <label>{{ Form::radio('Status', '1', ($Category->Status == "1" ? true : false)) }} Active</label>
                                                        <label>{{ Form::radio('Status', '0', ($Category->Status == "0" ? true : false)) }} Inactive</label>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

...
<html>
    <head>
        ...
        <title>LIT Diamond | Add new Product</title>
                                            ...
                                            <div class="box box-primary">
                                                ...
                                                <div class="box-body">
                                                    <div class="form-group">
                                                        ...
                                                        {{ Form::text('ProductName', null, ['class' => 'form-control', 'id' => 'ProductName', 'placeholder' => 'Enter Product Name']) }}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="CostPrice">Cost Price</label>
                                                        {{ Form::text('CostPrice', null, ['class' => 'form-control', 'id' => 'CostPrice', 'placeholder' => 'Enter Cost Price']) }}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="SalePrice">Sale Price</label>
                                                        {{ Form::text('SalePrice', null, ['class' => 'form-control', 'id' => 'SalePrice', 'placeholder' => 'Enter Sale Price']) }}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Qty">Qty</label>
                                                        {{ Form::text('Qty', null, ['class' => 'form-control', 'id' => 'Qty', 'placeholder' => 'Enter Qty']) }}
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="Desc">Desc</label>
                                                        {{ Form::textarea('Desc', null, ['class' => 'form-control', 'id' => 'Desc', 'placeholder' => 'Enter Desc']) }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>

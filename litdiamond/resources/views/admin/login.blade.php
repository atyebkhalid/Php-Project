...
<html>
    <head>
        ...
        <!-- iCheck -->
        <link rel="stylesheet" href="{{ url('resources/admin') }}/plugins/iCheck/square/blue.css">
    ...
    <body class="hold-transition login-page">
        <div class="login-box">
            <div class="login-logo">
                <a href="{{ url('resources/admin') }}/index2.html"><b>LIT</b>Admin</a>
            </div>
            <!-- /.login-logo -->
        ...
        <!-- iCheck -->
        <script src="{{ url('resources/admin') }}/plugins/iCheck/icheck.min.js"></script>
        <script>
            $(function () {
                $('input').iCheck({
